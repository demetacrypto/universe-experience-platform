...
Identity is observed; distances, physical sizes, star counts and central masses
are heterogeneous literature estimates. The 3-D star distribution rendered by
the client is a declared PROCEDURAL prior built to match the morphology class —
we do not have a resolved 3-D stellar map of these galaxies.
"""
...
GALAXIES = [
    {
        ...
        "central_bh": {"name": "Sagittarius A*", "mass_msun": 4.3e6, "detected": True,
                       "status": "measured", "note": "Imaged by the EHT in 2022."},
    ...
    },
    {
        ...
        "central_bh": {"name": "M31*", "mass_msun": 1.4e8, "detected": True,
                       "status": "literature_estimate", "note": "A nearby ~140-million-solar-mass SMBH."},
        "note": ("The nearest large galaxy and approaching the Milky Way. Whether and when the "
                 "two merge remains model-sensitive; recent studies give materially different "
                 "probabilities and timescales."),
        "future_source": ("Sawala et al., Nature Astronomy 9 (2025), doi:10.1038/s41550-025-02563-1; "
                          "Wu et al. 2026 preprint, arXiv:2603.22863."),
    ...
    },
    {
        ...
        "central_bh": {"name": "M33 nuclear constraint", "mass_upper_limit_msun": 3000,
                       "detected": False, "status": "upper_limit",
                       "note": "No central massive black hole detected; 3,000 M☉ is an upper limit.",
                       "source": "Gebhardt et al. 2001, AJ 122, 2469; arXiv:astro-ph/0107359."},
    ...
    },
    {
        ...
        "central_bh": {"name": "M51 nucleus", "mass_msun": 1.0e6, "detected": True,
                       "status": "literature_estimate", "note": "An active nucleus driving X-ray outflows."},
    ...
    },
    {
        ...
        "central_bh": {"name": "M101 nucleus", "mass_msun": 3.0e7, "detected": True,
                       "status": "literature_estimate", "note": "A relatively modest central black hole."},
    ...
    },
    {
        ...
        "central_bh": {"name": "Sombrero SMBH", "mass_msun": 1.0e9, "detected": True,
                       "status": "literature_estimate", "note": "One of the most massive SMBHs in the nearby universe."},
    ...
    },
    {
        ...
        "central_bh": {"name": "Cen A SMBH", "mass_msun": 5.5e7, "detected": True,
                       "status": "literature_estimate", "note": "Powers a giant radio jet spanning a million light-years."},
...
def build_payload(release: str) -> dict:
    source = source_metadata("galaxy_compilation")
    return {
        "layer": "galaxies",
        ...
        "provenance": {
            ...
            "note": ("Identity and morphology are observed; distances, sizes, star counts and "
                     "central masses are heterogeneous literature estimates. The rendered stellar "
                     "distribution is a declared procedural prior. Field-level citations remain "
                     "incomplete outside the explicitly cited exceptions."),
